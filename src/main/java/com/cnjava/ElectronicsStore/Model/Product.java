...
public class Product {
	...
	public Product(int productID, String productName, int price, String description, String imageLink, String state,
			String supples, String colors, int status, Category category, Brand brand, List<Comment> comments) {
		super();
		ProductID = productID;
	...
	public Product(String productName, int price, String description, String imageLink, Brand brand, Category category
			,String colors, String state, String supples, int status) {
		super();
	...
	public void copy(String name, String description, int price, String state, String colors,
					 String supples, Brand brand, Category category
			) {
